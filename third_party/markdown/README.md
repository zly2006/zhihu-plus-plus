...
- 内置日期：2026-07-21
- 生产源码清单 SHA-256：`c42c3f1483e77eed5c803fbc8855da4550a4636d95e3b3c35b31b01be2ac614d`
...
issue #495 的性能修复位于 Zhihu++ 自己的 HTML 转 AST 与正文组合层：首屏只解析少量顶层 HTML 块，滚动接近末端时再增量解析后续块，并复用已经生成的 AST。这样不会通过 benchmark 预解析来绕过真实卡顿点。vendored renderer 继续保留 1.2.9 的选择与布局语义；脚注实现则恢复自[上游 PR #15](https://github.com/huarangmeng/Markdown/pull/15)，并仅按其评论中的方案增加 1px 宽度补偿，修复 Android AVD 上的舍入裁切。
