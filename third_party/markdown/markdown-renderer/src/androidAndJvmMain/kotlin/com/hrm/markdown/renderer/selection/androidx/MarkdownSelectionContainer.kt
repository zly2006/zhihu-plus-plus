 ...
 * [LazyColumn][androidx.compose.foundation.lazy.LazyColumn], within a [MarkdownSelectionContainer] has
 ...
 */
@Composable
internal fun MarkdownSelectionContainer(modifier: Modifier = Modifier, content: @Composable () -> Unit) {
    var selection by remember { mutableStateOf<Selection?>(null) }
    MarkdownSelectionContainer(
        modifier = modifier,
        selection = selection,
 ...
 */
@Composable
internal fun MarkdownDisableSelection(content: @Composable () -> Unit) {
...
@Composable
internal fun MarkdownSelectionContainer(
    /** A [Modifier] for MarkdownSelectionContainer. */
    ...
    val registrarImpl =
        rememberSaveable(saver = MarkdownSelectionRegistrarImpl.Saver) { MarkdownSelectionRegistrarImpl() }

    val manager = remember { MarkdownSelectionManager(registrarImpl) }
    ...
    SimpleLayout(modifier = modifier.then(manager.modifier)) {
        MarkdownSelectionContextMenuArea(manager) {
...
@OptIn(ExperimentalFoundationApi::class)
@Composable
private fun MarkdownSelectionContextMenuArea(
    ...
    if (ComposeFoundationFlags.isNewContextMenuEnabled) {
        ...
        androidx.compose.foundation.contextmenu.ContextMenuArea(
            ...
            contextMenuBuilderBlock = manager.markdownSelectionContextMenuBuilder(state),
            content = content,
        )
    }
}
