...
internal actual fun Modifier.markdownSelectionMagnifier(manager: MarkdownSelectionManager): Modifier {
    ...
    return composed {
        ...
        animatedSelectionMagnifier(
            magnifierCenter = { calculateMarkdownSelectionMagnifierCenterAndroid(manager, magnifierSize) },
