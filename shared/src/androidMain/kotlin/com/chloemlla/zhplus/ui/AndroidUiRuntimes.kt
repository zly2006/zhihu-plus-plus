...
import com.chloemlla.zhplus.ui.components.CustomWebView
import com.chloemlla.zhplus.ui.components.WebviewComp
import com.chloemlla.zhplus.ui.components.setupUpWebviewClient
import com.chloemlla.zhplus.updater.UpdateManager
import com.chloemlla.zhplus.util.EmojiManager
import com.chloemlla.zhplus.util.OpenInBrowser
import com.chloemlla.zhplus.util.createEmojiInlineContent
import com.chloemlla.zhplus.util.fuckHonorService
import com.chloemlla.zhplus.viewmodel.NotificationViewModel
import com.chloemlla.zhplus.viewmodel.filter.encodeBlocklistBackup
import com.chloemlla.zhplus.viewmodel.filter.getContentFilterDatabase
import com.chloemlla.zhplus.viewmodel.filter.importBlocklistBackupFromJsonText
import com.chloemlla.zhplus.viewmodel.notificationEnvironment
...
private const val LOGIN_ACTIVITY_CLASS = "com.chloemlla.zhplus.LoginActivity"
private const val QR_CODE_SCAN_ACTIVITY_CLASS = "com.chloemlla.zhplus.QRCodeScanActivity"
private const val WEBVIEW_ACTIVITY_CLASS = "com.chloemlla.zhplus.WebviewActivity"
    ...
    return remember(context) {
        suspend {
            ...
            if (data.login) {
                ...
                val self = ZhihuJson.decodeJson<com.chloemlla.zhplus.shared.data.Person>(response)
...
actual fun ArticlePreviewPreloadEffect(
    cached: com.chloemlla.zhplus.viewmodel.ArticleViewModel.CachedAnswerContent?,
    isNext: Boolean,
    title: String,
...
actual fun rememberHomeLoginRequester(): () -> Unit {
    ...
    return remember(context) {
        {
            val intent = Intent().setClassName(context.packageName, "com.chloemlla.zhplus.LoginActivity")
...
): com.chloemlla.zhplus.viewmodel.NotificationEnvironment {
    val context = LocalContext.current
