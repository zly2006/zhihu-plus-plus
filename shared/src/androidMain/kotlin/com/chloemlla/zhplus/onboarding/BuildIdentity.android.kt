...
private fun Context.readBuildIdentity(): BuildIdentity {
    ...
    val gitHash = meta.metaString("com.chloemlla.zhplus.GIT_HASH")
    val commitHash =
        meta
            .metaString("com.chloemlla.zhplus.COMMIT_HASH")
            .ifBlank { gitHash }
            .ifBlank { "unknown" }
    val shortHash =
        when {
    ...
    val buildTime =
        meta.metaLong("com.chloemlla.zhplus.BUILD_TIME").takeIf { it > 0L }
            ?: meta.metaLong("com.chloemlla.zhplus.BUILD_TIME_UTC_MILLIS")
