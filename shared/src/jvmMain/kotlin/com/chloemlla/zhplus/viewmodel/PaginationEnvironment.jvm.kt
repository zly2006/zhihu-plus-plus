...
import com.chloemlla.zhplus.shared.desktop.DesktopHistoryStorage
import com.chloemlla.zhplus.shared.desktop.copyDesktopPlainText
import com.chloemlla.zhplus.shared.desktop.desktopZhihuDataFile
import com.chloemlla.zhplus.shared.desktop.desktopZhihuDownloadsDir
...
import com.chloemlla.zhplus.shared.filter.TrackedContentIdentity
import com.chloemlla.zhplus.shared.notification.NotificationSettingsStore
import com.chloemlla.zhplus.shared.notification.desktopNotificationSettingsStore
import com.chloemlla.zhplus.shared.platform.desktopSettingsStore
import com.chloemlla.zhplus.shared.util.Log
import com.chloemlla.zhplus.ui.ArticleAnswerSwitchState
import com.chloemlla.zhplus.util.buildArticleExportFileName
import com.chloemlla.zhplus.util.buildCollectionExportZipFileName
import com.chloemlla.zhplus.util.sanitizeArticleExportFileNamePart
import com.chloemlla.zhplus.viewmodel.filter.BlockedKeywordService
...
import com.chloemlla.zhplus.viewmodel.filter.ContentFilterManager
import com.chloemlla.zhplus.viewmodel.filter.ContentType
import com.chloemlla.zhplus.viewmodel.filter.FeedContentFilterPipeline
import com.chloemlla.zhplus.viewmodel.filter.FeedDisplayFilterPipeline
import com.chloemlla.zhplus.viewmodel.filter.ForegroundReadFilterPipeline
import com.chloemlla.zhplus.viewmodel.filter.getContentFilterDatabase
import com.chloemlla.zhplus.viewmodel.filter.toFeedFilterSettings
import com.chloemlla.zhplus.viewmodel.local.LocalRecommendationEngine
import com.chloemlla.zhplus.viewmodel.local.buildLocalRecommendationEngine
import com.chloemlla.zhplus.viewmodel.local.getLocalContentDatabase
...
import com.chloemlla.zhplus.util.buildArticleExportHtml as buildSharedArticleExportHtml
import com.chloemlla.zhplus.util.buildOfflineArticleExportHtml as buildSharedOfflineArticleExportHtml
...
class DesktopPaginationEnvironment(
    ...
    override suspend fun addBlockedQuestionAuthor(
        ...
        contentFilterDb.blockedQuestionAuthorDao().insertUser(
            com.chloemlla.zhplus.viewmodel.filter.BlockedQuestionAuthor(
                userId = userId,
                userName = userName,
                urlToken = urlToken,
                avatarUrl = avatarUrl,
