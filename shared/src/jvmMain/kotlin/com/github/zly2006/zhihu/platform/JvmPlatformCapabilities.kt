...
import com.github.zly2006.zhihu.desktop.exportDesktopSettings
import com.github.zly2006.zhihu.desktop.openDesktopExternalUrl
import com.github.zly2006.zhihu.desktop.readDesktopPlainText
...
actual fun rememberDeveloperDiagnostics(): DeveloperDiagnostics = remember {
    DeveloperDiagnostics(
        ...
        // 桌面端没有等价的 ConnectivityManager，探测网络类型需要额外原生依赖，这里只声明未知。
        networkStatus = "未知",
        readClipboardText = { readDesktopPlainText() },
        exportAllSettings = { exportDesktopSettings() },
    )
}
