...
package com.chloemlla.zhplus.shared.util

import com.chloemlla.zhplus.shared.data.SegmentInfoMark
import com.chloemlla.zhplus.shared.data.SegmentInfoMeta
import com.chloemlla.zhplus.shared.data.SegmentInfoParagraph
import com.chloemlla.zhplus.shared.data.effectiveSegInfo
...
fun applySegmentInfosToHtml(
    ...
    segmentInfos.forEach { paragraph ->
        ...
        // https://github.com/Chloemlla/zhihu-plus-plus/issues/418
