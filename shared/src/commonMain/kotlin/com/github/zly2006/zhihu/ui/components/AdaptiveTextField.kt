...
fun AdaptiveOutlinedTextField(
    ...
    shape: Shape = if (LocalLiquidGlass.current) MaterialTheme.shapes.medium else OutlinedTextFieldDefaults.shape,
...
@Composable
private fun adaptiveTextFieldColors(): TextFieldColors = if (LocalLiquidGlass.current) {
