...
@Composable
fun CommentScreenSheetContent(
    showComments: Boolean,
    onDismiss: () -> Unit,
    content: NavDestination,
    commentScreen: @Composable (
        content: NavDestination,
        activeCommentItem: CommentItem?,
    ...
    if (showComments) {
        MyModalBottomSheet(
            ...
            dragHandle = { CommentSheetDragHandleTitle("评论") },
        ) {
            commentScreen(
                content,
                null,
    ...
    if (showComments && activeChildComment != null && childTarget != null) {
        MyModalBottomSheet(
            ...
            dragHandle = { CommentSheetDragHandleTitle("回复") },
        ) {
            commentScreen(
                childTarget,
                activeChildComment,
...
@Composable
private fun CommentSheetDragHandleTitle(text: String) {
    Column {
