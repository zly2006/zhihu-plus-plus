...
object DataHolder {
    suspend fun getContentDetail(
        ...
        val apiUrl = when (dest.type) {
            ...
            ArticleType.Answer -> "https://www.zhihu.com/api/v4/answers/${dest.id}?include=content,paid_info,can_comment,excerpt,thanks_count,voteup_count,question.topics,comment_count,visited_count,reaction,reaction.relation.voting"
