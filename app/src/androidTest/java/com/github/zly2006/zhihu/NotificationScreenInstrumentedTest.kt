...
class NotificationScreenInstrumentedTest {
    ...
    fun notificationScreen_showsStableToolbarActionsWithoutLiveData() {
        ...
        composeRule.onNodeWithTag("notification_category_comment").assertIsDisplayed().assertHasClickAction()
        composeRule.onNodeWithTag("notification_category_like").assertIsDisplayed().assertHasClickAction()
        composeRule.onNodeWithTag("notification_category_favorite").assertIsDisplayed().assertHasClickAction()
        composeRule.onNodeWithTag("notification_category_follow").assertIsDisplayed().assertHasClickAction()
